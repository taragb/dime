...
for row in tabulated:
	ob = {"label": "COMPÉTENCE MUNICIPALE 2013/14", "year": "2013/14", "commune": row['COMMUNE'], "total_points": 0, "max_points": 100, "items":[

			{"label": "ÉCOLES PRIMAIRES", "points": 0, "max_points": 30, "items": [
				{"label": "Taux d'Admission du CEP comparé à\nla moyenne nationale", "value": row['passing_exam'], "score": row['s_passing_exam'], "points": [0,5,10], "scale_marks": [0,2,4]},
				{"label": "d'écoles recevant les fournitures\nscolaires avant le début de l'année\nscolaire 2013/2014", "value": row['supplies_recieved'], "score": row['s_supplies'], "points": [0,1,4,6,8,10], "scale_marks": [20,40,60,80,90,100]},
				{"label": "d'écoles avec un forage fonctionnel", "value": row['access'], "score": row['s_water_access'], "points": [0,4,6,8,10], "scale_marks": [0,1,2,3,4]},
				{"label": "d’écoles avec des latrines\nfonctionnelles pour chaque classe", "value": row['latrines_per_class'], "score": row['s_latrines'], "points": [0,4,6,8,10], "scale_marks": [0,1,2,3,4]}
			]},
			{"label": "SANTÉ", "points": 0, "max_points": 30, "items": [
				{"label": "d’accouchements assistés\npendant l’année", "value": row['assisted_births'], "score": row['s_assisted_births'], "points": [0,5,10], "scale_marks": [0,2,4]},
				{"label": "de nourrissons 0-11 mois ayant été\nvaccinés avec le BCG, VAR, VAA, VPO3,\nDTC-Hep+Hib3 en 2013", "value": row['vac_total'], "score": row['s_vaccine'], "points": [0,1,4,6,8,10], "scale_marks": [20,40,60,80,90,100]},
			...
			{"label": "EAU ET ASSAINISSEMENT", "points": 0, "max_points": 60, "items": [
				{"label": "de la population avec accès à une\nsource d’eau potable fonctionnelle à\n1000m pour 300 personnes/ forage.*", "value": row['access'], "score": row['s_water_access'], "points": [0,5,10,15,30], "scale_marks": [50,1000,2200,4500,7500]}
			]},
			{"label": "ACTES DE NAISSANCES", "points": 0, "max_points": 60, "items": [
				{"label": "Nombre d’actes de naissances\ndélivrés comparé aux naissances\nattendues", "value": row['projected_births_v'], "score": row['s_projected_births'], "points": [0,5,10,15,30], "scale_marks": [50,1000,2200,4500,7500]}
			]}
